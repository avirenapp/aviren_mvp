...
cred_path = 'service.json'
db = firestore.Client.from_service_account_json(cred_path)
collection_name = 'users'

app = Flask(__name__)

genai.configure(api_key="AIzaSyC82X8ZxqCzVRJNYJJUC7M31UiVo3ew0-w")
...
def generate_content():
    ...
    try:
        ...
        print(e)
        responseError = requests.post("https://paraphrase.pythonanywhere.com/generate", headers={"Content-Type": "application/json"})
